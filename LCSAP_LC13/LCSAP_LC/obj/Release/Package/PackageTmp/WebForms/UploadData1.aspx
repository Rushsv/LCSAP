<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadData1.aspx.cs" Inherits="LCSAP_LC.UploadData1" %>
...
<body>
    <div class="container">
        <form id="form1" runat="server">
            <div class="row">
                <div class="col-md-6">
                    <h3>Choose Course Activity Info File (EnQ_Course_Activity.csv)<asp:FileUpload ID="FileUpload1" runat="server" Width="792px" />
                    </h3>
                    <p>
